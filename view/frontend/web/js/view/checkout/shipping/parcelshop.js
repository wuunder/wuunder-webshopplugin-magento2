            ...
            this.selectedMethod = ko.computed(function () {
                ...
                if (selectedMethod === 'parcelshop-picker_parcelshop-picker') {
                    if ($('#wuunder_parcelshop_container').length === 0) {
                        ...
                        $('#wuunder_parcelshop_container').html('<div id="parcelshop" class="parcelshopwrapper"><a href="#" id="get_parcels_link" onclick="_showParcelshopLocator()">' + $.mage.__('Click here to select your Parcelshop') + '</a><div id="map_container"><div id="map_canvas" class="gmaps"></div></div></div>');
                    }
                } else {
